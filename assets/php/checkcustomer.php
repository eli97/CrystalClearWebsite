<?php
    ...
    foreach($customers as $customer) {
        if($customer['gid'] == $checkid) {
            ...
            echo json_encode(['location' => 'https://crystalclearwestsac.com/index.html']);
            exit;
            //header('Location:https://crystalclearwestsac.com/profile.php');
        }
        /*else {
            //print_r("first time user");
            //echo "<script type='text/javascript'>window.top.location='https://crystalclearwestsac.com/account.php';</script>"; exit;
            header('Content-Type: application/json');
