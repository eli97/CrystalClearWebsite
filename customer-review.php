...
<body>
    ...
    <div style="padding: 200px;background: url(&quot;assets/img/water1.png&quot;) top / cover no-repeat;padding-top: 50px;">
    <main class="container justify-content-center" >
        ...
        <div class="rating"> 
            ...
            <input type="radio" name="rating" id="star1" value="1"> <label for="star1" class="fa fa-star"></label>
                ...
                <div class="mb-3">
                    <label for="textMsg" class="form-label" id="textMsg">Comment:</label>
                    <textarea class="form-control" id="textMsg" rows="3" ></textarea>
                </div>
