...
if (!file_exists($composerAutoload)) {
    ...
    if (!file_exists($composerAutoload)) {
        echo "FROM BOOTSTRAP: The 'vendor' folder is missing. You must run 'composer update' to resolve application dependencies.\nPlease see the README for more information.\n";
        exit(1);
    }
}
...
$clientId = 'AS9OF1qrA62ErCfktIrTM5P2pLO6lqdgqKPvdyhiuIW0VbVX7utCiohS10dJeFAYNAmubd9Wp4nfdFnl';
$clientSecret = 'EHLfmInYkPDuD2n5oZNDN5_dmq46RXL1lBn_QLzomFKO7Gykt12kXIcYrEREBbDminK-LzeH5X7LMeUf';
